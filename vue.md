...
> На секции всегда можно поделить любой другой компонент. Page, section, component и тд могут иметь секции!
...
Слои создают рамки и контекст разработки. Зашёл в `composables` — там composables и правила работы с ними. Зашёл в `managers` — там менеджеры со своей логикой. Слой сигнализирует, что здесь можно ожидать, и не даёт разным типам сущностей перемешиваться в одном месте.
